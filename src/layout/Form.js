                    ...
                    <form>
                        <div className="d-flex">
                            <div className={`d-flex align-items-center ${formcss.form_box}`}>
                                <label htmlFor="calender" className={formcss.forLabel}>선택일자</label>
                                <input className={formcss.for_input_sele} type="text" id="datepicker" name="calender" placeholder="날짜를 선택하세요" />
                            </div>
                            <div className={`d-flex align-items-center ${formcss.form_box}`}>
                                {/* <!-- 희망시간 --> */}
                                <label htmlFor="input2" className={formcss.forLabel}>희망시간</label>
                        ...
                        <div className={`d-flex align-items-center ${formcss.form_box_etc}`}>
                            <label htmlFor="input7" className={formcss.forLabel}>필요서비스</label>
                        ...
                        <div className="d-flex">
                            <div className={`d-flex align-items-center ${formcss.form_box} ${formcss.addressinput}`}>
                                <label htmlFor="input1" className={formcss.forLabel}>주소</label>
                                <input type="text" id="sample5_address" className={` me-3 ${formcss.for_input}`} placeholder="상세주소도 함께 입력해주세요" />
                                <button type="button" onClick={() => sample5_execDaumPostcode()} style={{ border: 'none', backgroundColor: 'transparent' }}>
